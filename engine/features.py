...
import re
import shlex  # Replace pipes with shlex
import sqlite3
import struct
import subprocess
import time
...
import pvporcupine
import requests  # Add requests module for internet connection check
...
def chatBot(query):
    ...
    chatbot = hugchat.ChatBot(cookie_path=r"engine\cookies.json")  # Use raw string to fix invalid escape sequence
